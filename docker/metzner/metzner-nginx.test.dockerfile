...
# terminal
# docker build -t metzner-nginx-test -f docker/metzner/metzner-nginx.test.dockerfile .
# docker run --name metzner-nginx-test -dp 80:80 -p 443:443 metzner-nginx-test

# docker hub
# docker build -t ddrram/metzner-nginx-test:1.1.0 -f docker/metzner/metzner-nginx.test.dockerfile .
